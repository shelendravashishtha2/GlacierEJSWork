...
const ppmEquipmentAssetSchema = new mongoose.Schema({
	ppmEquipmentId: {
...
const ppmEquipmentAsset = new mongoose.model("ppm_Equipment_Asset", ppmEquipmentAssetSchema);
module.exports = ppmEquipmentAsset;